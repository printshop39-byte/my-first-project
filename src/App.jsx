    ...
    try {
      ...
      const userContent = [
          ...
          : [{ type: "image", source: { type: "base64", media_type: file.type || "image/jpeg", data: b64 } }]),
        {
          type: "text",
          text:
`हा महाराष्ट्र शासनाच्या ई-महाभूमी (mahabhumi.gov.in) पोर्टलवरून घेतलेला डिजिटल ७/१२ उतारा आहे — गाव नमुना सात (अधिकार अभिलेख पत्रक) आणि गाव नमुना बारा (पिकांची नोंदवही).

खालील ९ नियम अत्यंत काळजीपूर्वक पाळा. प्रत्येक field वेगळ्या ठिकाणाहून येतो — गोंधळ करू नका.

१. village — Header मध्ये "गाव :-" नंतर येणारे नाव. ब्रॅकेटमधील LGD code (उदा. ५६७३८८) वगळा. उदा. "गाव :- बालिंगे(५६७३८८)" → village = "बालिंगे". ⚠ करवीर/कोल्हापूर हे गाव नाहीत.

२. taluka — "तालुका :-" नंतर येणारे नाव. गाव आणि तालुका वेगळे.

३. district — "जिल्हा :-" नंतर येणारे नाव.

४. survey_no ⚠ Critical: header मधील "गट क्रमांक व उपविभाग" खाली दिलेला पूर्ण code (slashes, उपविभाग अ/ब/क, प्लॉट नं. — सगळं एकत्र). उदा. "५४/१/प्लॉ.नं.४७". ⚠ "खाते क्र." (account number उदा. १०३१/९०३१) हा survey नाही — तो वेगळा कॉलम!

५. area ⚠ scrambled करू नका: मुख्य "क्षेत्र" कॉलमचे पहिले मूल्य (हेक्टर.आर.चौ.मी). उदा. "२.१५.२५". ⚠ "आकार" (२१.५३ — कर), "फेरफार क्र." (६३७२/९२०२४ — mutation entry) हे क्षेत्र नाहीत.

६. land_type — बागायत/जिरायत/अकृषिक/बिनशेती/NA/निवासी यापैकी जे लिहिले असेल.

७. owner ⚠ अक्षरे काळजीपूर्वक: "भोगवटादाराचे नाव" कॉलममधील पूर्ण नाव. "पा" आणि "म" चुकवू नका (पाटील, पवार, पाटोळे). "ट"/"ठ", "ण"/"न" वेगळे आहेत. अनिश्चित असेल तर रिक्त ठेवा, अंदाज नका लावू.

८. latitude/longitude — explicitly लिहिले असतील तरच भरा, नसेल तर रिक्त ("").

९. फक्त शुद्ध JSON द्या. प्रस्तावना नको, markdown नको:

{
  ...
  "longitude": ""
      ...
      // Calls our serverless proxy at /api/ocr (which adds the ANTHROPIC_API_KEY
      // server-side and forwards to api.anthropic.com). The proxy expects a
      // standard Messages API "messages" array and adds the model+headers itself.
